// Chunk-streamed, FOV-culled forest. Same shape as v04, but `viewChunks` is
// now driven by the graphics tier so low-tier devices stream a smaller halo.
...
export function buildWorld(scene, templates, { worldSeed = 1337, viewChunks = 4, treeCastShadow = false } = {}) {
