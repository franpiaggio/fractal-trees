...
export const CONFIG = {
  densityMin:  8,     // objects/chunk in clearings (raised from 4 — clearings were too empty)
  densityMax:  28,    // objects/chunk in thickets
  ...
  trellisChance: 0.01,
  // per-species multiplier — bias the mix (e.g. a mostly-oak forest)
  speciesWeight: { oak: 1, ash: 1, aspen: 1, pine: 1 },
};
